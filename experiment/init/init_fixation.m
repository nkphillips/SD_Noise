...
p.fixation_space_aperture_deg = 0.5; % diameter in visual degrees
p.fixation_space_aperture_px = round(p.fixation_space_aperture_deg * w.ppd); % px
...
p.fixation_dot_deg = 0.12; % inner fixation dot size in visual degrees (default = 0.15°)
