...
% Reversals
staircases.max_reversals = 16;
staircases.num_reversals_to_consider = staircases.max_reversals / 2;

% Trials
staircases.max_trials_per_sc = ceil(staircases.max_reversals * 5 * 1.2); % Each reversal might take 3-5 trials on average; Add ~20% buffer for variability
...
staircases.response_dur = nan(staircases.num_staircases_per_cond, staircases.max_trials_per_sc, p.num_levels, p.num_conds);
