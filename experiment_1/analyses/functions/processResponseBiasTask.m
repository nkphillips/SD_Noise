...
% the response bias estimation function.
%
% Inputs:
...
%
% Outputs:
%   result - struct containing estimation results (start_params, start_nll, params_est, nll, exit_flag)
...
function result = processResponseBiasTask(task_data, p)
    ...
    [start_params, start_nll, params_est, nll, exit_flag] = estimateResponseBias(fixed_params, p);
