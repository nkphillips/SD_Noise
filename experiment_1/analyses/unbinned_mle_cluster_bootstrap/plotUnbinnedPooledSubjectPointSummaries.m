...
% plotUnbinnedPooledSubjectPointSummaries  Pooled estimates with faint subject points.
    ...
    local_renderOne(fig_dir, pack.amp, subj_pack.amp, subj_pack.at_bound, ...
        'Amplitude', 'unbinned_mle_super_sd_amplitude_pooled_subject_points.pdf', ...
        'Unbinned MLE: pooled amplitude with subject-level points', ...
        contrast_lbl, precision_lbl, plot_opts);

    local_renderOne(fig_dir, pack.fwhm, subj_pack.fwhm, subj_pack.at_bound, ...
        'Width FWHM (deg)', 'unbinned_mle_super_sd_width_fwhm_pooled_subject_points.pdf', ...
        'Unbinned MLE: pooled FWHM with subject-level points', ...
        contrast_lbl, precision_lbl, plot_opts);
end
