...
function local_renderMetric(fig_dir, vals, ci_lo, ci_hi, n_back_list, contrast_lbl, precision_lbl, ...
    ...
    for cond = 1:2
        ...
        out_pdf = fullfile(fig_dir, sprintf('serial_dependence_%s_by_nback_%s.pdf', ...
