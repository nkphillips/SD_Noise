...
if toggles.which_setup == 0 % Macbook
...
elseif any(toggles.which_setup == 1:3) % ASUS

    switch toggles.which_setup 
        case 1
...
elseif toggles.which_setup == 4 % S32D850
