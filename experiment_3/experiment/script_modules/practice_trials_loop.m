...
while n_trial <= p.num_trials_per_block
    ...
    if no_response
        ...
        if n_trial == 1
            ...
            if toggles.demo_run, disp('No response! Previous trial will repeat.'); end
        ...
        elseif redo_trial == 0
            ...
            if toggles.demo_run, disp('No response! Redo trial will be reattempted.'); end

        end

    else

        if toggles.demo_run && redo_trial, disp('Redo successful.'); end
