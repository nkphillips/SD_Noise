...
% averages and SEM for each major condition (Contrast, Filter Width) and for
...
%   p: struct with fields feature_name, contrast, filter_width
%
% Output
    ...
    for prev_lvl = 1:num_levels
        for curr_lvl = 1:num_levels
            ...
            if cond == 1
                ...
                prev_label = p.filter_width{prev_lvl}; curr_label = p.filter_width{curr_lvl};
            end
