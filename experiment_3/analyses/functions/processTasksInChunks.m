function [all_results, task_indices] = processTasksInChunks(task_list, num_chunks, use_parallel, processing_function, toggles, varargin)
    ...
    if use_parallel 
        ...
        if toggles.show_debug_output, disp('    - Starting sequential processing...'); end
