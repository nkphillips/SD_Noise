...
mu_range = [2 8]; % Discrimination threshold in degrees
sigma_range = [5 10]; % Controls steepness of psychometric function
guess_rate_range = [0.01 0.25]; % Small probability of guesses 
